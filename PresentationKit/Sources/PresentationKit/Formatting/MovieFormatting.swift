...
public enum MovieFormatting {
    ...
    public static func year(_ releaseDate: Date?, in timeZone: TimeZone = .gmt) -> String? {
    ...
    public static func rating(average: Double, count: Int) -> String? {
